...
class BankAccount:
    ...
    def add_transaction(self, amount, d_or_w):
        if d_or_w == "deposit":
            t = 0
        elif d_or_w == 'withdraw':
            t=1
        else:
            t=2
        self.transactions.append(Transaction(0 if self.transactions == [] else self.transactions[-1].id+1,
                                 self.balance-amount if t==0 else self.balance, 
                                 self.balance if t==0 or t==2 else self.balance - amount))
